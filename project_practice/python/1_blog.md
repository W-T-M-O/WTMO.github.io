...
menubar2: project_practice_python_menu
show_sidebar: false
hero_image: /path/to/title.jpg
hero_darken: true
toc: true
toc_title: 목차
description: 파이썬의 기본 구조를 이용하여 블로그형태를 만들어본다.
---
...
{% include tag.html tag="python" %}  {% include tag.html tag="blog" %}  {% include tag.html tag="practice code" %}